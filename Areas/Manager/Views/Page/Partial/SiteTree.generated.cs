...
namespace Piranha.Areas.Manager.Views.Page.Partial
{
    ...
    public class SiteTree : System.Web.Mvc.WebViewPage<List<Sitemap>>
    {
        public SiteTree()
        {
        }
...
WriteLiteral("\" class=\"");
            ...
            #line 5 "..\..\Areas\Manager\Views\Page\Partial\SiteTree.cshtml"
                         Write(page.Pages.Count > 0 ? (page.Level <= ViewBag.Levels || page.HasChild(ViewBag.Expanded) ? "expanded" : "collapsed") : string.Empty);
...
WriteLiteral(" ");
            ...
            #line 5 "..\..\Areas\Manager\Views\Page\Partial\SiteTree.cshtml"
                                                                                                                                                               Write(page.Updated > page.LastPublished ? "draft" : string.Empty);
...
WriteLiteral("\', ");
            ...
            #line default
            #line hidden
WriteLiteral(") \" type=\"submit\"></button>\r\n            <button class=\"icon add-below marg\" titl" +
"e=\"");
...
WriteLiteral("\">\r\n                                 ");
            ...
            #line 21 "..\..\Areas\Manager\Views\Page\Partial\SiteTree.cshtml"
                            Write(Html.Raw((!string.IsNullOrEmpty(page.NavigationTitle) ? page.NavigationTitle : page.Title) + (page.LastPublished == DateTime.MinValue ? "<span class=info-unpublished></span>" : (page.Updated > page.LastPublished ? "<span class=info-draft></span>" : string.Empty))));
