    ...
    e.create("tinymce.themes.AdvancedTheme", {
        ...
        init: function(j, k) {
            ...
            j.onInit.add(function() {
                if (!j.settings.readonly) {
                    ...
                    j.dom.bind(j.dom.getRoot(), "dragend", function() { l._updateUndoStatus(j); });
                }
            });
        ...
        _createStyleSelect: function(m) {
            ...
            l = j.createListBox("styleselect", {
                ...
                onselect: function(o) {
                    var p, n = [];
                    f(l.items, function(q) { n.push(q.value); });
                    i.focus();
                    i.undoManager.add();
        ...
        _createFontSelect: function() {
            ...
            k = i.controlManager.createListBox("fontselect", {
                ...
                onselect: function(l) {
                    ...
                    k.select(function(n) { return l == n; });
                    if (m && m.value == l) {
                        k.select(null);
                    }
                    return false;
        ...
        _createFontSizeSelect: function() {
            ...
            n = k.controlManager.createListBox("fontsizeselect", {
                ...
                onselect: function(i) {
                    ...
                    n.select(function(p) { return i == p; });
        ...
        _addStatusBar: function(m, j) {
            ...
            if (w.theme_advanced_resizing) {
                ...
                p.onPostRender.add(function() {
                    b.add(p.id + "_resize", "click", function(n) { n.preventDefault(); });
        ...
        _nodeChanged: function(m, r, D, q, E) {
            ...
            e.each(y.stateControls, function(n) { r.setActive(n, m.queryCommandState(y.controls[n][1])); });
            ...
            if (G = r.get("styleselect")) {
                y._importClasses();
                j = [];
                f(G.items, function(n) { j.push(n.value); });
            ...
            if (G = r.get("fontselect")) {
                G.select(function(n) { return n.replace(/^([^,]+).*/, "$1").toLowerCase() == u; });
            }
            ...
            if (z.theme_advanced_path && z.theme_advanced_statusbar_location) {
                ...
                if (d.select("a", C).length > 0) {
                    y.statusKeyboardNavigation = new e.ui.KeyboardNavigation({ root: m.id + "_path_row", items: d.select("a", C), excludeFromTabOrder: true, onCancel: function() { m.focus(); } }, d);
                }
            }
        },
