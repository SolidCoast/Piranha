(function(e) {
    ...
    var c = {
        ...
        map: function(g, h) {
            var i = [];
            c.each(g, function(f) { i.push(h(f)); });
            return i;
        },
        grep: function(g, h) {
            var i = [];
        ...
        trim: function(f) { return (f ? "" + f : "").replace(a, ""); },
        create: function(o, f, j) {
            ...
            if (o[5]) {
                ...
                h = i[k];
                if (m) {
                    i[k] = function() { return g[l].apply(this, arguments); };
                } else {
                    i[k] = function() {
                        this.parent = g[l];
                ...
                i[k].prototype[k] = i[k];
                n.each(g, function(p, q) { i[k].prototype[q] = g[q]; });
            ...
            n.each(f["static"], function(p, q) { i[k][q] = p; });
            if (this.onCreate) {
...
(function(a) { a.VK = { BACKSPACE: 8, DELETE: 46, DOWN: 40, ENTER: 13, LEFT: 37, RIGHT: 39, SPACEBAR: 32, TAB: 9, UP: 38, modifierPressed: function(b) { return b.shiftKey || b.ctrlKey || b.altKey; }, metaKeyPressed: function(b) { return a.isMac ? b.metaKey : b.ctrlKey && !b.altKey; } }; })(tinymce);
tinymce.util.Quirks = function(d) {
    ...
    function j() {
        ...
        d.addCommand("Delete", function() { G(); });
    }
    ...
    function y() {
        if (!d.settings.content_editable) {
            p.bind(d.getDoc(), "focusin", function(G) { E.setRng(E.getRng()); });
        ...
        function H() {
            ...
            return function() {
                ...
                if (K !== d.getBody()) {
                    ...
                    tinymce.each(J, function(L) { K.setAttributeNode(L.cloneNode(true)); });
                }
            };
        }

        function G() { return !E.isCollapsed() && p.getParent(E.getStart(), p.isBlock) != p.getParent(E.getEnd(), p.isBlock); }
    ...
    function D() { document.body.setAttribute("role", "application"); }
    ...
    function v() {
        if (s.forced_root_block) {
            d.onInit.add(function() { c("DefaultParagraphSeparator", s.forced_root_block); });
        }
    }
    ...
    function i() {
        ...
        if (z() >= 10) {
            G = "";
            tinymce.each("p div h1 h2 h3 h4 h5 h6".split(" "), function(H, I) { G += (I > 0 ? "," : "") + H + ":empty"; });
    ...
    function g() {
        ...
        function P() {
            ...
            tinymce.each(p.select("img[data-mce-selected]"), function(ab) { ab.removeAttribute("data-mce-selected"); });
            if (aa) {
                L(aa);
            } else {
                N();
...
(function(j) {
    ...
    j.html = j.html || { };
    j.html.Entities = {
        encodeRaw: function(m, l) { return m.replace(l ? k : b, function(n) { return g[n] || n; }); },
        encodeAllRaw: function(l) { return ("" + l).replace(f, function(m) { return g[m] || m; }); },
        ...
        encodeNamed: function(n, l, m) {
            m = m || a;
            return n.replace(l ? k : b, function(o) { return g[o] || m[o] || o; });
        },
...
tinymce.html.Styles = function(d, f) {
    ...
    return {
        toHex: function(i) { return i.replace(k, c); },
        parse: function(s) {
            ...
            function i(C, B) {
                if (r) {
                    C = C.replace(/\uFEFF[0-9]/g, function(D) { return a[D]; });
                }
                if (!B) {
                    C = C.replace(/\\([\'\";:])/g, "$1");
                }
            ...
            if (s) {
                s = s.replace(/\\[\"\';:\uFEFF]/g, t).replace(/\"[^\"]+\"|\'[^\']+\'/g, function(B) { return B.replace(/[;:]/g, t); });
                while (q = b.exec(s)) {
...
(function(f) {
    ...
    function d(j, i) { return j.split(i || ","); }

    function h(m, l) {
        var j, k = { };

        function i(n) { return n.replace(/[A-Z]+/g, function(o) { return i(m[o]); }); }
    ...
    f.html.Schema = function(A) {
        ...
        if (A.valid_styles) {
            D = { };
            g(A.valid_styles, function(F, E) { D[E] = f.explode(F); });
        }
        ...
        function i(E) { return new RegExp("^" + E.replace(/([?+*])/g, ".$1") + "$"); }
        ...
        function t(E) {
            ...
            j = [];
            C(E);
            g(y, function(G, F) { k[F] = G.children; });
        }
        ...
        if (!A.valid_elements) {
            ...
            g(d("p,h1,h2,h3,h4,h5,h6,th,td,pre,div,address,caption"), function(E) { s[E].paddEmpty = true; });
        } else {
            t(A.valid_elements);
        }
        l(A.custom_elements);
        ...
        u.children = k;
        u.styles = D;
        u.getBoolAttrs = function() { return r; };
        u.getBlockElements = function() { return v; };
        u.getShortEndedElements = function() { return z; };
        u.getSelfClosingElements = function() { return q; };
        u.getNonEmptyElements = function() { return n; };
        u.getWhiteSpaceElements = function() { return o; };
        ...
        u.getElementRule = B;
        u.getCustomElements = function() { return p; };
...
(function(d) {
    ...
    d.extend(b.prototype, {
        ...
        walk: function(f) { return a(this, null, f); }
    });
    d.extend(b, {
        create: function(g, f) {
            var i, h;
    ...
    b.html.DomParser = function(g, h) {
        ...
        f.parse = function(v, m) {
            ...
            n = new b.html.SaxParser({
                ...
                cdata: function(l) { B.append(K("#cdata", 4)).value = l; },
                text: function(P, l) {
                    var O;
                    if (!L) {
                        P = P.replace(k, " ");
                ...
                comment: function(l) { B.append(K("#comment", 8)).value = l; },
                pi: function(l, O) {
...
tinymce.html.Writer = function(e) {
    ...
    return {
        ...
        cdata: function(h) { c.push("<![CDATA[", h, "]]>"); },
        comment: function(h) { c.push("<!--", h, "-->"); },
        pi: function(h, i) {
            if (i) {
                c.push("<?", h, " ", i, "?>");
            } else {
        ...
        reset: function() { c.length = 0; },
        getContent: function() { return c.join("").replace(/\n$/, ""); }
    };
};
(function(a) {
    a.html.Serializer = function(c, d) {
        ...
        b.serialize = function(h) {
            ...
            i = c.validate;
            g = {
                3: function(k, j) { e.text(k.value, k.raw); },
                8: function(j) { e.comment(j.value); },
                7: function(j) { e.pi(j.name, j.value); },
                10: function(j) { e.doctype(j.value); },
                4: function(j) { e.cdata(j.value); },
                11: function(j) {
                    if ((j = j.firstChild)) {
                        do {
                            f(j);
...
(function(b, h) {
    ...
    b.EventUtils = f;
    b.Event = new f(function(i) { return function(j) { tinymce.dom.Event.callNativeHandler(i, j); }; });
...
tinymce.dom.TreeWalker = function(a, c) {
    ...
    this.prev = function(e) { return (b = d(b, "lastChild", "previousSibling", e)); };
};
(function(e) {
    ...
    e.create("tinymce.dom.DOMUtils", {
        ...
        fixDoc: function(k) {
            ...
            if (b && j.schema) {
                ("abbr article aside audio canvas details figcaption figure footer header hgroup mark menu meter nav output progress section summary time video").replace(/\w+/g, function(l) { k.createElement(l); });
        ...
        clone: function(k, i) {
            ...
            if (!i) {
                ...
                g(j.getAttribs(k), function(n) { j.setAttrib(m, n.nodeName, j.getAttrib(k, n.nodeName)); });
                return m;
            }
            return m.firstChild;
        },
        ...
        getParent: function(k, j, i) { return this.getParents(k, j, i, false); },
        getParents: function(s, m, k, q) {
            ...
            if (d(m, "string")) {
                i = m;
                if (m === "*") {
                    m = function(o) { return o.nodeType == 1; };
                } else {
                    m = function(o) { return j.is(o, i); };
                }
            }
            while (s) {
        ...
        getNext: function(j, i) { return this._findSib(j, i, "nextSibling"); },
        getPrev: function(j, i) { return this._findSib(j, i, "previousSibling"); },
        select: function(k, j) {
            var i = this;
        ...
        create: function(k, i, j) { return this.add(this.doc.createElement(k), k, i, j, 1); },
        ...
        setStyle: function(l, i, j) {
            ...
            return k.run(l, function(o) {
                var n, m;
                n = o.style;
                i = i.replace(/-(\D)/g, function(q, p) { return p.toUpperCase(); });
        ...
        getStyle: function(l, i, k) {
            ...
            if (this.doc.defaultView && k) {
                i = i.replace(/[A-Z]/g, function(m) { return "-" + m; });
                try {
        ...
        setStyles: function(l, m) {
            ...
            i = k.update_styles;
            k.update_styles = 0;
            g(m, function(o, p) { j.setStyle(l, p, o); });
            k.update_styles = i;
            if (k.update_styles) {
        ...
        setAttrib: function(k, l, i) {
            ...
            return this.run(k, function(p) {
                ...
                if (i !== null) {
                    ...
                    case "style":
                        if (!d(i, "string")) {
                            g(i, function(q, r) { j.setStyle(p, r, q); });
                            return;
                        }
                        if (o.keep_values) {
                            if (i && !j._isRes(i)) {
        ...
        setAttribs: function(j, k) {
            var i = this;
            return this.run(j, function(l) { g(k, function(m, o) { i.setAttrib(l, o, m); }); });
        },
        ...
        parseStyle: function(i) { return this.styles.parse(i); },
        serializeStyle: function(j, i) { return this.styles.serialize(j, i); },
        addStyle: function(j) {
            var k = this.doc, i;
        ...
        show: function(i) { return this.setStyle(i, "display", "block"); },
        hide: function(i) { return this.setStyle(i, "display", "none"); },
        isHidden: function(i) {
            i = this.get(i);
            return !i || i.style.display == "none" || this.getStyle(i, "display") == "none";
        },
        uniqueId: function(i) { return (!i ? "mce_" : i) + (this.counter++); },
        ...
        replace: function(m, l, i) {
            ...
            return j.run(l, function(k) {
                if (i) {
                    g(e.grep(k.childNodes), function(n) { m.appendChild(n); });
                }
        ...
        rename: function(l, i) {
            ...
            if (l.nodeName != i.toUpperCase()) {
                j = k.create(i);
                g(k.getAttribs(l), function(m) { k.setAttrib(j, m.nodeName, k.getAttrib(l, m.nodeName)); });
                k.replace(j, l, 1);
            }
            return j || l;
        },
        ...
        getAttribs: function(j) {
            ...
            if (b) {
                ...
                j.cloneNode(false).outerHTML.replace(/<\/?[\w:\-]+ ?|=[\"][^\"]+\"|=\'[^\']+\'|=[\w\-]+|>/gi, "").replace(/[\w:\-]+/gi, function(k) { i.push({ specified: 1, nodeName: k }); });
                return i;
            }
            return j.attributes;
        },
        ...
        bind: function(l, i, k, j) { return this.events.add(l, i, k, j || this); },
        unbind: function(k, i, j) { return this.events.remove(k, i, j); },
        fire: function(k, j, i) { return this.events.fire(k, j, i); },
        ...
        _isRes: function(i) { return /^(top|left|bottom|right|width|height)/i.test(i) || /;\s*(top|left|bottom|right|width|height)/i.test(i); }
    });
...
(function(a) {
    ...
    function b(c) {
        ...
        function x() { return e.createDocumentFragment(); }
    ...
    a.Range = b;
    b.prototype.toString = function() { return this.toStringIE(); };
})(tinymce.dom);
(function() {
...
(function() {
    ...
    d.matches = function(e, y) { return d(e, null, null, y); };
    d.matchesSelector = function(e, y) { return d(y, null, null, [e]).length > 0; };
    ...
    d.error = function(e) { throw new Error("Syntax error, unrecognized expression: " + e); };
    ...
    var k = d.selectors = {
        ...
        preFilter: {
            ...
            ID: function(e) { return e[1].replace(q, ""); },
            TAG: function(y, e) { return y[1].replace(q, "").toLowerCase(); },
            CHILD: function(e) {
                if (e[1] === "nth") {
                    if (!e[2]) {
                        d.error(e[0]);
        ...
        filters: {
            ...
            has: function(z, y, e) { return !!d(e[3], z).length; },
        ...
        setFilters: { first: function(y, e) { return e === 0; }, last: function(z, y, e, A) { return y === A.length - 1; }, even: function(y, e) { return e % 2 === 0; }, odd: function(y, e) { return e % 2 === 1; }, lt: function(z, y, e) { return y < e[3] - 0; }, gt: function(z, y, e) { return y > e[3] - 0; }, nth: function(z, y, e) { return e[3] - 0 === y; }, eq: function(z, y, e) { return e[3] - 0 === y; } },
        filter: {
            ...
            TAG: function(y, e) { return (e === "*" && y.nodeType === 1) || !!y.nodeName && y.nodeName.toLowerCase() === e; },
    ...
    var j = k.match.POS, c = function(y, e) { return "\\" + (e - 0 + 1); };
    ...
    (function() {
        ...
        if (e.firstChild && typeof e.firstChild.getAttribute !== "undefined" && e.firstChild.getAttribute("href") !== "#") {
            k.attrHandle.href = function(y) { return y.getAttribute("href", 2); };
        }
        e = null;
    })();
    ...
    if (document.documentElement.contains) {
        d.contains = function(y, e) { return y !== e && (y.contains ? y.contains(e) : true); };
    } else {
        if (document.documentElement.compareDocumentPosition) {
            d.contains = function(y, e) { return !!(y.compareDocumentPosition(e) & 16); };
        } else {
            d.contains = function() { return false; };
        }
    }
    d.isXML = function(e) {
...
(function(d) {
    ...
    d.create("tinymce.dom.Selection", {
        Selection: function(k, j, i, h) {
            ...
            g.serializer = i;
            g.editor = h;
            e(["onBeforeSetContent", "onBeforeGetContent", "onSetContent", "onGetContent"], function(l) { g[l] = new d.util.Dispatcher(g); });
                ...
                h.editor.onNodeChange.addToTop(function(l, k, o) {
                    ...
                    e(h.selectorChangedData, function(r, q) {
                        e(m, function(s) {
                            if (p.is(s, q)) {
                                if (!i[q]) {
                                    e(r, function(t) { t(true, { node: s, selector: q, parents: m }); });
                                    i[q] = r;
                                }
                                n[q] = r;
                                return false;
                    ...
                    e(i, function(r, q) {
                        if (!n[q]) {
                            delete i[q];
                            e(r, function(s) { s(false, { node: o, selector: q, parents: m }); });
                        }
                    });
                });
            }
        ...
        return {
            ...
            serialize: function(o, m) {
                ...
                if (l.createHTMLDocument) {
                    ...
                    g(o.nodeName == "BODY" ? o.childNodes : [o], function(q) { p.body.appendChild(p.importNode(q, true)); });
                    if (o.nodeName != "BODY") {
                        o = p.body.firstChild;
                    } else {
                        o = p.body;
            ...
            addRules: function(j) { f.addValidElements(j); },
            setRules: function(j) { f.setValidElements(j); }
        };
    };
})(tinymce);
(function(a) {
    a.dom.ScriptLoader = function(h) {
        ...
        this.loadScripts = function(m, q, p) {
            ...
            function n(r) {
                a.each(e[r], function(s) { s.func.call(s.scope); });
                e[r] = f;
            }
...
(function(a) {
    a.dom.RangeUtils = function(c) {
        ...
        this.split = function(e) {
            ...
            function f(j, k) { return j.splitText(k); }
...
(function(b) {
    ...
    b.create("tinymce.ui.KeyboardNavigation", {
        KeyboardNavigation: function(e, f) {
            ...
            f = f || b.DOM;
            k = function(r) { g = r.target.id; };
            h = function(r) { f.setAttrib(r.target.id, "tabindex", "-1"); };
            d = function(r) {
                var s = f.get(g);
                f.setAttrib(s, "tabindex", "0");
                s.focus();
            };
            q.focus = function() { f.get(g).focus(); };
            q.destroy = function() {
                c(m, function(s) {
                    var t = f.get(s.id);
                    f.unbind(t, "focus", k);
...
(function(c) {
    ...
    c.create("tinymce.ui.Control", {
        ...
        focus: function() { b.get(this.id).focus(); },
...
(function(e) {
    ...
    e.create("tinymce.ui.DropMenu:tinymce.ui.Menu", {
        ...
        _setupKeyboardNav: function() {
            ...
            h.splice(0, 0, i);
            g.keyboardNav = new e.ui.KeyboardNavigation({ root: "menu_" + g.id, items: h, onCancel: function() { g.hideMenu(); }, enableUpDown: true });
            i.focus();
        },
...
(function(e) {
    ...
    e.create("tinymce.ui.ListBox:tinymce.ui.Control", {
        ...
        mark: function(g) { this.marked[g] = true; },
        add: function(j, g, i) {
            var h = this;
            i = i || { };
...
(function(c) {
    ...
    c.create("tinymce.ui.SplitButton:tinymce.ui.MenuButton", {
        ...
        postRender: function() {
            ...
            a.add([e.id, e.id + "_open"], "focus", function() { e._focused = 1; });
            a.add([e.id, e.id + "_open"], "blur", function() { e._focused = 0; });
...
(function(d) {
    ...
    d.create("tinymce.ui.ColorSplitButton:tinymce.ui.SplitButton", {
        ...
        renderMenu: function() {
            ...
            a.add(p.id + "_menu", "mousedown", function(i) { return a.cancel(i); });
...
(function(b) {
    ...
    b.create("tinymce.ui.ToolbarGroup:tinymce.ui.Container", {
        renderHTML: function() {
            ...
            j(e, function(h) { i.push(h.renderHTML()); });
            i.push("</span>");
            i.push("</div>");
            return i.join("");
        },
...
(function(b) {
    ...
    b.create("tinymce.AddOnManager", {
        ...
        addComponents: function(f, d) {
            var e = this.urls[f];
            b.each(d, function(g) { b.ScriptLoader.add(e + "/" + g); });
        },
...
(function(k) {
    ...
    k.create("tinymce.Editor", {
        ...
        render: function(o) {
            ...
            if (!j.domLoaded) {
                j.add(window, "ready", function() { p.render(); });
                return;
            }
            tinyMCE.settings = q;
            if (!p.getElement()) {
        ...
        init: function() {
            ...
            function A(s) {
                ...
                if (t && k.inArray(r, s) === -1) {
                    i(c.dependencies(s), function(u) { A(u); });
                    n = new t(G, o);
                    G.plugins[s] = n;
                    if (n.init) {
                        n.init(G, o);
            ...
            if (H.render_ui && G.theme) {
                ...
                if (typeof H.theme != "function") {
                    ...
                    if (b) {
                        G.onInit.add(function(n) { n.dom.bind(n.getBody(), "beforedeactivate keydown", function() { n.lastIERng = n.selection.getRng(); }); });
                    }
                }
                G.editorContainer = p.editorContainer;
            }
            if (H.content_css) {
                i(g(H.content_css), function(n) { G.contentCSS.push(G.documentBaseURI.toAbsolute(n)); });
            }
            if (H.content_style) {
        ...
        initContentBody: function() {
            ...
            n.serializer.onPreProcess.add(function(t, u) { return n.onPreProcess.dispatch(n, u, t); });
            n.serializer.onPostProcess.add(function(t, u) { return n.onPostProcess.dispatch(n, u, t); });
            ...
            if (p.protect) {
                n.onBeforeSetContent.add(function(t, u) { i(p.protect, function(v) { u.content = u.content.replace(v, function(x) { return "<!--mce:protected " + escape(x) + "-->"; }); }); });
            }
            n.onSetContent.add(function() { n.addVisual(n.getBody()); });
            if (p.padd_empty_editor) {
                n.onPostProcess.add(function(t, u) { u.content = u.content.replace(/^(<p[^>]*>(&nbsp;|&#160;|\s|\u00a0|)<\/p>[\r\n]*|<br \/>[\r\n]*)$/, ""); });
            }
            ...
            if (n.contentStyles.length > 0) {
                s = "";
                i(n.contentStyles, function(t) { s += t + "\r\n"; });
                n.dom.addStyle(s);
            }
            i(n.contentCSS, function(t) { n.dom.loadCSS(t); });
            if (p.auto_focus) {
                setTimeout(function() {
        ...
        translate: function(m) {
            ...
            return n[o + "." + m] || m.replace(/\{\#([^\}]+)\}/g, function(q, p) { return n[o + "." + p] || "{#" + p + "}"; });
        },
        getLang: function(o, m) { return k.i18n[(this.settings.language || "en") + "." + o] || (d(m) ? m : "{#" + o + "}"); },
        ...
        addCommand: function(m, o, n) { this.execCommands[m] = { func: o, scope: n || this }; },
        addQueryStateHandler: function(m, o, n) { this.queryStateCommands[m] = { func: o, scope: n || this }; },
        addQueryValueHandler: function(m, o, n) { this.queryValueCommands[m] = { func: o, scope: n || this }; },
        addShortcut: function(o, q, m, p) {
            ...
            if (d(m, "string")) {
                r = m;
                m = function() { n.execCommand(r, false, null); };
            }
            if (d(m, "object")) {
                r = m;
                m = function() { n.execCommand(r[0], r[1], r[2]); };
            }
            i(g(o), function(s) {
        ...
        isHidden: function() { return !l.isHidden(this.id); },
        ...
        getElement: function() { return l.get(this.settings.content_element || this.id); },
        getWin: function() {
            var m = this, n;
            if (!m.contentWindow) {
                n = l.get(m.id + "_ifr");
...
(function(a) {
    ...
    a.Editor.prototype.setupEvents = function() {
        ...
        b(["onPreInit", "onBeforeRenderUI", "onPostRender", "onLoad", "onInit", "onRemove", "onActivate", "onDeactivate", "onClick", "onEvent", "onMouseUp", "onMouseDown", "onDblClick", "onKeyDown", "onKeyUp", "onKeyPress", "onContextMenu", "onSubmit", "onReset", "onPaste", "onPreProcess", "onPostProcess", "onBeforeSetContent", "onBeforeGetContent", "onSetContent", "onGetContent", "onLoadContent", "onSaveContent", "onNodeChange", "onChange", "onBeforeExecCommand", "onExecCommand", "onUndo", "onRedo", "onVisualAid", "onSetProgressState", "onSetAttrib"], function(e) { c[e] = new a.util.Dispatcher(c); });
        if (d.cleanup_callback) {
            c.onBeforeSetContent.add(function(e, f) { f.content = e.execCallback("cleanup_callback", "insert_to_editor", f.content, f); });
        ...
        if (d.handle_node_change_callback) {
            c.onNodeChange.add(function(f, e, g) { f.execCallback("handle_node_change_callback", f.id, g, -1, -1, true, f.selection.isCollapsed()); });
        }
        if (d.save_callback) {
        ...
        if (d.onchange_callback) {
            c.onChange.add(function(f, e) { f.execCallback("onchange_callback", f, e); });
        }
    };
    a.Editor.prototype.bindNativeEvents = function() {
        ...
        e.bind(d.content_editable ? l.getBody() : (a.isGecko ? l.getDoc() : l.getWin()), "focus", function(i) { l.focus(true); });
        ...
        l.onReset.add(function() { l.setContent(l.startContent, { format: "raw" }); });
        ...
        l.onKeyUp.add(function(i, m) { g(m); });
        l.onKeyPress.add(function(i, m) { g(m); });
        l.onKeyDown.add(function(i, m) { g(m, true); });
        if (a.isOpera) {
            l.onClick.add(function(i, m) { m.preventDefault(); });
        }
    };
})(tinymce);
(function(d) {
    ...
    d.EditorCommands = function(n) {
        ...
        function u(v, x) {
            x = x || "exec";
            e(v, function(z, y) { e(y.toLowerCase().split(","), function(A) { j[x][A] = z; }); });
        }
        ...
        u({
            ...
            "Bold,Italic,Underline,Strikethrough,Superscript,Subscript": function(v) { s(v); },
            "ForeColor,HiliteColor,FontName": function(y, x, v) { s(y, v); },
            ...
            RemoveFormat: function(v) { q.remove(v); },
            mceBlockQuote: function(v) { s("blockquote"); },
            FormatBlock: function(y, x, v) { return s(v || "p"); },
            mceCleanup: function() {
                var v = p.getBookmark();
            ...
            mceSelectNode: function(y, x, v) { p.select(v); },
            mceInsertContent: function(B, I, K) {
                ...
                if (!G.invalid) {
                    ...
                    K = J.serialize(y.parse(K.replace(/<span (id="mce_marker"|id=mce_marker).+?<\/span>/i, function() { return J.serialize(F); })));
                    if (E == z) {
                        m.setHTML(z, K);
                    } else {
                        m.setOuterHTML(E, K);
            ...
            mceInsertRawHTML: function(y, x, v) {
                ...
                n.setContent(n.getContent().replace(/tiny_mce_marker/g, function() { return v; }));
            },
            mceToggleFormat: function(y, x, v) { s(v); },
            mceSetContent: function(y, x, v) { n.setContent(v); },
            ...
            mceToggleFormat: function(y, x, v) { q.toggle(v); },
            InsertHorizontalRule: function() { n.execCommand("mceInsertContent", false, "<hr />"); },
            mceToggleVisualAid: function() {
                n.hasVisual = !n.hasVisual;
                n.addVisual();
            },
            mceReplaceContent: function(y, x, v) { n.execCommand("mceInsertContent", false, v.replace(/\{\$selection\}/g, p.getContent({ format: "text" }))); },
        ...
        u({
            "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function(z) {
                ...
                var y = d.map(v, function(A) { return !!q.matchNode(A, x); });
                return d.inArray(y, a) !== -1;
            },
            "Bold,Italic,Underline,Strikethrough,Superscript,Subscript": function(v) { return t(v); },
            mceBlockQuote: function() { return t("blockquote"); },
            Outdent: function() {
                var v;
                if (k.inline_styles) {
        ...
        u({ Undo: function() { n.undoManager.undo(); }, Redo: function() { n.undoManager.redo(); } });
    };
})(tinymce);
(function(b) {
    ...
    b.UndoManager = function(h) {
        ...
        function c() { return b.trim(h.getContent({ format: "raw", no_events: 1 }).replace(/<span[^>]+data-mce-bogus[^>]+>[\u200B\uFEFF]+<\/span>/g, "")); }
        ...
        j.add(function(m, n) { return h.onUndo.dispatch(h, n, m); });
        f.add(function(m, n) { return h.onRedo.dispatch(h, n, m); });
        h.onInit.add(function() { l.add(); });
        ...
        l = {
            ...
            onUndo: j,
            onRedo: f,
            beforeChange: function() { g = h.selection.getBookmark(2, true); },
            add: function(p) {
            ...
            hasUndo: function() { return i > 0 || this.typing; },
            hasRedo: function() { return i < e.length - 1 && !this.typing; }
        };
        return l;
    };
})(tinymce);
...
(function(c) {
    ...
    c.create("tinymce.ControlManager", {
        ...
        createListBox: function(f, n, h) {
            ...
            function g(o) { return o.settings.use_accessible_selects && !c.isGecko; }
            ...
            if (c.isWebKit) {
                k.onPostRender.add(function(p, o) {
                    a.add(o, "mousedown", function() { j.bookmark = j.selection.getBookmark(1); });
...
(function(a) {
    a.Formatter = function(aa) {
        ...
        function A(ab) { return ab instanceof Array; }
        ...
        function j() {
            ...
            T("p h1 h2 h3 h4 h5 h6 div address pre div code dt dd samp".split(/\s/), function(ab) { l(ab, { block: ab, remove: "all" }); });
        ...
        function Y(ae, al, ag) {
            ...
            function ab(aq, ap) {
                ...
                if (aq) {
                    ...
                    T(ap.styles, function(at, ar) { c.setStyle(aq, ar, q(at, al)); });
                    T(ap.attributes, function(at, ar) { c.setAttrib(aq, ar, q(at, al)); });
            ...
            function ad(at, ay, aw, av, aq) {
                ...
                if (ar <= 0 || (aA < ar && au > ar)) {
                    ...
                    av.push(az);
                    T(ap, function(aB) { az.appendChild(aB); });
                    return az;
                }
            }
        ...
        function k(ad, af, ae) {
            ...
            function ab(ag) {
                ag = c.getParent(ag, function(ah) { return !!y(ah, ad, af, true); });
                return y(ag, ad, af);
            }
            ...
            if (!P) {
                ...
                aa.onNodeChange.addToTop(function(ag, af, ai) {
                    ...
                    T(P, function(ak, al) {
                        T(ah, function(am) {
                            if (y(am, al, { }, ak.similar)) {
                                if (!ad[al]) {
                                    T(ak, function(an) { an(true, { node: am, format: al, parents: ah }); });
                                    ad[al] = ak;
                                }
                                aj[al] = ak;
                                return false;
                    ...
                    T(ad, function(ak, al) {
                        if (!aj[al]) {
                            delete ad[al];
                            T(ak, function(am) { am(false, { node: ai, format: al, parents: ah }); });
                        }
                    });
                });
            }
        ...
        function q(ab, ac) {
            if (typeof(ab) != "string") {
                ...
                if (ac) {
                    ab = ab.replace(/%(\w+)/g, function(ae, ad) { return ac[ad] || ae; });
                }
            }
            return ab;
        }
        ...
        function u(af, ae) {
            ...
            if (af && ae) {
                ...
                if (ah(af, ae)) {
                    ...
                    c.remove(ae);
                    T(a.grep(ae.childNodes), function(ai) { af.appendChild(ai); });
                    return af;
                }
            }
            return ae;
        ...
        function I(ab) { return /^(h[1-6]|p|div|pre|address|dl|dt|dd)$/.test(ab); }
...
tinymce.onAddEditor.add(function(e, a) {
    ...
    if (c.inline_styles) {
        ...
        d = { font: function(j, i) { b(i, { backgroundColor: i.style.backgroundColor, color: i.color, fontFamily: i.face, fontSize: h[parseInt(i.size, 10) - 1] }); }, u: function(j, i) { b(i, { textDecoration: "underline" }); }, strike: function(j, i) { b(i, { textDecoration: "line-through" }); } };
...
(function(b) {
    ...
    b.EnterKey = function(f) {
        ...
        function g(A) {
            ...
            function E(N) { return N && i.isBlock(N) && !/^(TD|TH|CAPTION|FORM)$/.test(N.nodeName) && !/^(fixed|absolute)/i.test(N.style.position) && i.getContentEditable(N) !== "true"; }
